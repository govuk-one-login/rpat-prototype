function setupKeyWarningRoutes(router) {
  ...
  router.get("/create-client-key-warning/redirect-urls", (req, res) => {
    res.render("/create-client-key-warning/redirect-urls.html", {
  ...
  router.post(
    "/create-client-key-warning/redirect-urls",
    (req, res) => {
      ...
      res.redirect("/create-client-key-warning/redirect-urls");
    }
  );

  router.get(
    "/create-client-key-warning/redirect-urls/delete/:id",
    (req, res) => {
  ...
  router.get("/create-client-key-warning/confirm", (req, res) => {
    const redirectUrls = req.cookies.redirectUrls;
    res.render("/create-client-key-warning/confirm.html", {
  ...
  const createTableEntries = (allUrls) => {
    return allUrls.map((url, index) => {
      return [
        ...
        {
          html:
            '<a href="/create-client-key-warning/redirect-urls/delete/' +
            index +
            '">Delete</a>',
        },
      ];
