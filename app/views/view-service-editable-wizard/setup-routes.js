function setupViewServiceEditableWizardRoutes(router) {
  setupTableRoutesForUrl(router, "/view-service-editable-wizard/edit-redirect-urls");
  setupTableRoutesForUrl(router, "/view-service-editable-wizard/edit-back-channel-logout-urls");
  setupTableRoutesForUrl(router, "/view-service-editable-wizard/edit-contacts");
  setupTableRoutesForUrl(router, "/view-service-editable-wizard/edit-post-logout-redirect-urls");
}
