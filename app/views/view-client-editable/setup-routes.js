function setupViewClientEditableRoutes(router) {
  setupTableRoutesForUrl(router, "/view-client-editable/edit-redirect-urls");
  setupTableRoutesForUrl(router, "/view-client-editable/edit-back-channel-logout-urls");
  setupTableRoutesForUrl(router, "/view-client-editable/edit-contacts");
  setupTableRoutesForUrl(router, "/view-client-editable/edit-post-logout-redirect-urls");
}
