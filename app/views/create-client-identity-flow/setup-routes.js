function setupCreateClientIdentityFlowRoutes(router) {
  // Add your routes here
  router.get("/create-client-identity-flow/redirect-urls", (req, res) => {
    res.render("/create-client-identity-flow/redirect-urls.html", {
  ...
  router.post(
    "/create-client-identity-flow/redirect-urls",
    (req, res) => {
      ...
      res.redirect("/create-client-identity-flow/redirect-urls");
    }
  );

  router.get(
    "/create-client-identity-flow/redirect-urls/delete/:id",
    (req, res) => {
  ...
  router.get("/create-client-identity-flow/confirm", (req, res) => {
    const redirectUrls = req.cookies.redirectUrls;
    res.render("/create-client-identity-flow/confirm.html", {
